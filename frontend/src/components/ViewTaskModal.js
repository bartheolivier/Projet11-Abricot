 ...
 *        1. Affichage du projet parent, de l'échéance et des membres assignés.
 *        2. Historique complet des commentaires avec les avatars des auteurs.
 *        3. Accessibilité WCAG 2.1 (Touche Échap, ARIA, Focus Trap).
 * =========================================================================================
 */
...
export default function ViewTaskModal({ isOpen, task, onClose }) {
  // Accessibilité WCAG 2.1 : Touche Échap et verrouillage du scroll
  useEffect(() => {
